...
function SideBar() {
    ...
    return (
        <div className={`${selectedUser?'hidden':'block'} lg:block lg:w-[30%] w-full h-screen bg-[#d5f4ec] shadow-gray-700 shadow-2xl`}>
            ...
            <div className='w-full h-75 bg-[#77c8b4] rounded-b-[30%] shadow-gray-400 shadow-2xl flex flex-col justify-center px-5'>
                ...
                <div className='w-full flex items-center gap-5'>
                    ...
                    {!search && otherUsers?.map((user) => (
                        <div key={user._id} className=' w-12 h-12 rounded-full overflow-hidden flex justify-center items-center shadow-gray-700 shadow-lg'>
            ...
            <div className='w-full h-[60vh] overflow-auto flex flex-col gap-5 mt-5 items-center'>
                {otherUsers?.map((user) => (
                    <div key={user._id} onClick={()=>dispatch(setSelectedUser(user))} className='w-[95%] h-15 flex justify-start items-center gap-5 bg-white shadow-gray-700 shadow-2xl rounded-4xl mx-2 hover:bg-[#c8f2e7] cursor-pointer  '>   
                        <div className=' w-15 h-15  rounded-full overflow-hidden flex justify-center items-center shadow-gray-700 shadow-lg'>
                            <img src={user.image || dp} className='h-full' />
